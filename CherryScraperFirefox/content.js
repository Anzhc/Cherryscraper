...
function addButton() {
    ...
    const scrapeAction = function() {
        gatherData(function(data) {
            ...
            browser.runtime.sendMessage({action: 'gatherData', data: data});
            
            // Create a string from the tags.
            let tagsString = data.tags.join(',');
...
browser.storage.local.get('buttonEnabled', function(data) {
